package id.ac.umn.w10_27137.TutorialAsyncTaskLoader;
...
public class AsyncTaskLoaderActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void> {
    ...
    onLoaderReset(@NonNull Loader<Void> loader) {
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        ...
        public ContohLoader(@NonNull Context context, int n, AsyncTaskLoaderActivity main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<AsyncTaskLoaderActivity>(main);
        }
