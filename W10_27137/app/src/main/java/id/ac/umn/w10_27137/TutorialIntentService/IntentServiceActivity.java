package id.ac.umn.w10_27137.TutorialIntentService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartService.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                Intent intent = new Intent(IntentServiceActivity.this, CustomService.class);
                startService(intent);
            }
        });

        Intent intent2 = new Intent(IntentServiceActivity.this, CustomBoundService.class);
